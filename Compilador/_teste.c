...
void main(){
    // --- Inicialização ---
    makeNewQuadTest(OP_MOVI, *createRegisterAddr(11), createNumericAddr(10), createEmptyAddr());
    ...
    // --- Aritmética ---
    makeNewQuadTest(OP_ADDR, *createRegisterAddr(3), *createRegisterAddr(1), *createRegisterAddr(11));
    makeNewQuadTest(OP_ADDI, *createRegisterAddr(4), *createRegisterAddr(1), createNumericAddr(10));
    makeNewQuadTest(OP_SUBR, *createRegisterAddr(5), *createRegisterAddr(1), *createRegisterAddr(11));
    makeNewQuadTest(OP_SUBI, *createRegisterAddr(6), *createRegisterAddr(1), createNumericAddr(10));
    makeNewQuadTest(OP_MULR, *createRegisterAddr(7), *createRegisterAddr(1), *createRegisterAddr(11));
    makeNewQuadTest(OP_MULI, *createRegisterAddr(8), *createRegisterAddr(1), createNumericAddr(10));
    makeNewQuadTest(OP_DIVR, *createRegisterAddr(9), *createRegisterAddr(1), *createRegisterAddr(11));
    ...
    makeNewQuadTest(OP_BEQ, *createRegisterAddr(11), *createRegisterAddr(1), l1);
    ...
    makeNewQuadTest(OP_BNE, *createRegisterAddr(11), *createRegisterAddr(1), l3);
    makeNewQuadTest(OP_HALT, createEmptyAddr(), createEmptyAddr(), createEmptyAddr());
    ...
    makeNewQuadTest(OP_BLT, *createRegisterAddr(11), *createRegisterAddr(1), l6);
    makeNewQuadTest(OP_HALT, createEmptyAddr(), createEmptyAddr(), createEmptyAddr());
    makeNewQuadTest(OP_LABEL, l6, createEmptyAddr(), createEmptyAddr());

    Address l7 = *createLabelAddr();
    Address l8 = *createLabelAddr();
    makeNewQuadTest(OP_BLT, *createRegisterAddr(1), *createRegisterAddr(11), l7);
    ...
    makeNewQuadTest(OP_BGT, *createRegisterAddr(1), *createRegisterAddr(11), l9);
    makeNewQuadTest(OP_HALT, createEmptyAddr(), createEmptyAddr(), createEmptyAddr());
    makeNewQuadTest(OP_LABEL, l9, createEmptyAddr(), createEmptyAddr());

    Address l10 = *createLabelAddr();
    Address l11 = *createLabelAddr();
    makeNewQuadTest(OP_BGT, *createRegisterAddr(11), *createRegisterAddr(1), l10);
    ...
    makeNewQuadTest(OP_BLE, *createRegisterAddr(11), *createRegisterAddr(1), l12);
    makeNewQuadTest(OP_HALT, createEmptyAddr(), createEmptyAddr(), createEmptyAddr());
    makeNewQuadTest(OP_LABEL, l12, createEmptyAddr(), createEmptyAddr());

    Address l13 = *createLabelAddr();
    Address l14 = *createLabelAddr();
    makeNewQuadTest(OP_BLE, *createRegisterAddr(1), *createRegisterAddr(11), l13);
    ...
    makeNewQuadTest(OP_BGE, *createRegisterAddr(1), *createRegisterAddr(11), l15);
    makeNewQuadTest(OP_HALT, createEmptyAddr(), createEmptyAddr(), createEmptyAddr());
    makeNewQuadTest(OP_LABEL, l15, createEmptyAddr(), createEmptyAddr());

    Address l16 = *createLabelAddr();
    Address l17 = *createLabelAddr();
    makeNewQuadTest(OP_BGE, *createRegisterAddr(11), *createRegisterAddr(1), l16);
    ...
    makeNewQuadTest(OP_MOVR, *createRegisterAddr(4), *createRegisterAddr(11), createEmptyAddr());
