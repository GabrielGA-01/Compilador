...
Um processador é um hardware capaz de executar instruções codificadas, realizando operações lógicas, aritméticas, controle de fluxo e acesso à memória. Ele é o cérebro do sistema computacional, responsável por processar dados e executar programas.

Todavia, utilizar um processador diretamente é muito complicado para os seres humanos, pois eles lidam exclusivamente com valores binários, o que não é fácil para a comprrensão humana e extremanete suscetíveis à erros ao programar.

Assim sendo, a solução para isso é a criação de linguagens de alto nível, mais compreensíveis para os seres humanos e que ao mesmo tempo possam ser traduzidas para o código de máquina, ou seja, o código binário que os processadores conseguem entender. O processo de tradução é realizado por um compilador, que é um software responsável por converter o código-fonte escrito em uma linguagem de alto nível para um código de máquina específico.	

Compreeder os compiladores é uma parte fundamental para a formação de um engenheiro da computação, que deve ser capaz de entender como o código-fonte é transformado em código de máquina, além de ser capaz de desenvolver um compilador simples.

Desse modo, esse relatório busca apresentar o desenvolvimento de um compilador escrito na linguagem C, que tem como objetivo traduzir um código-fonte escrito em C- para código intermediário, assembly e código binário. 

Além do mais, o código binário gerado é então enviado para um processador MIPS simulado utilizando o kit FPGA, que foi desenvolvido anteriormente durante a disciplina de Laboratório de Sistemas Computacionais: Arquitetura e Organização de Computadores, a fim de validar o funcionamento do compilador e entender de maneira completa o fluxo de ações desde a escrita do código C- atá a execução das instruções em binário no hardware.

Nas próximas seções serão apresentados os objetivos do projeto, a fundamentação teórica necessária para o desenvolvimento do processador e do compilador utilizados, por fim, o desenvolvimento em si, apresentando a organização do projeto, as estruturas de dados utilizadas e os resultados obtidos.
